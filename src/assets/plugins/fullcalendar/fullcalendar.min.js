!(function (t) {
    ...
    function a(e, n, i) {
        ...
        l(e),
            ...
            i && ((n -= h), (r = Math.floor(n / o.length)), (s = Math.floor(n - r * (o.length - 1)))),
    ...
    function wt(n, i, r) {
        ...
        return (
            e.isMoment(u) || et(u) || void 0 === u
                ...
                : ((s = !1),
                  (o = !1),
                  h ? (ee.test(u) ? ((u += "-01"), (n = [u]), (s = !0), (o = !0)) : (a = ne.exec(u)) && ((s = !a[5]), (o = !0))) : t.isArray(u) && (o = !0),
                  (l = i || s ? e.utc.apply(e, n) : e.apply(null, n)),
                  s ? ((l._ambigTime = !0), (l._ambigZone = !0)) : r && (o ? (l._ambigZone = !0) : h && l.utcOffset(u))),
            (l._fullCalendar = !0),
            l
        );
    }
                        ...
                        t.each(this.split(","), function (n, i) {
                            ...
                            "title" == i
                                ...
                                : ((r = o[i])
                                  ...
                                  h &&
                                      ...
                                      (w = t('<button type="button" class="' + y.join(" ") + '">' + m + "</button>")
                                          .click(function (t) {
                            ...
                            l &&
                                s
                                    ...
                                    .end(),
                            s.length > 1 ? ((i = t("<div/>")), l && i.addClass("fc-button-group"), i.append(s), r.append(i)) : r.append(s);
                    }),
                r
            );
        }
    ...
    function Ut() {
        ...
        function P(t) {
            null == t.allDay && (t.allDay = !(t.start.hasTime() || (t.end && t.end.hasTime()))),
                t.allDay ? (t.start.stripTime(), t.end && t.end.stripTime()) : (t.start.hasTime() || (t.start = q.applyTimezone(t.start.time(0))), t.end && !t.end.hasTime() && (t.end = q.applyTimezone(t.end.time(0))));
        }
        function _(e, n, i) {
            var r,
                s,
        ...
        function W(e, n, i) {
            ...
            return (
                ...
                O(n),
                (s = { start: e._start.clone(), end: e._end ? e._end.clone() : q.getDefaultEventEnd(e._allDay, e._start), allDay: n.allDay }),
                O(s),
        ...
        function Y(e, n, i, r, s, o) {
            ...
            return (
                ...
                t.each(e, function (e, u) {
                    var h, c;
                    (h = { start: u.start.clone(), end: u.end ? u.end.clone() : null, allDay: u.allDay }),
                        t.each(o, function (t) {
                            h[t] = u[t];
                        }),
                        ...
                        s && c.end.add(s),
                        a && !c.allDay && (r || s) && (c.start.stripZone(), c.end && c.end.stripZone()),
                        t.extend(u, o, c),
                        jt(u),
                        l.push(function () {
                            t.extend(u, h), jt(u);
    ...
    var de = ce.extend({
        ...
        compoundTask: function (t) {
            ...
            if (t.namespace && ("destroy" === t.type || "init" === t.type)) {
                ...
                "destroy" === t.type
                    ? i.length && ((n = i[i.length - 1]), n.namespace === t.namespace && ("init" === n.type ? ((r = !1), i.pop()) : "destroy" === n.type && (r = !1)))
                    : "init" === t.type && i.length && ((n = i[i.length - 1]), n.namespace === t.namespace && "init" === n.type && i.pop());
            }
            return r && i.push(t), r;
        },
    });
    ...
    var fe = (Zt.EmitterMixin = {
        ...
        pe = bt.extend(ge, {
            ...
            position: function () {
                ...
                (r = o.top || 0),
                    ...
                    d.is(window) || d.is(document) ? ((d = h), (e = 0), (n = 0)) : ((i = d.offset()), (e = i.top), (n = i.left)),
                    (e += h.scrollTop()),
                    (n += h.scrollLeft()),
                    !1 !== o.viewportConstrain && ((r = Math.min(r, e + d.outerHeight() - u - this.margin)), (r = Math.max(r, e + this.margin)), (s = Math.min(s, n + d.outerWidth() - l - this.margin)), (s = Math.max(s, n + this.margin))),
        ...
        me = (Zt.DragListener = bt.extend(ge, {
            ...
            bindHandlers: function () {
                var e = we.get();
                this.isGeneric
                    ? this.listenTo(t(document), { drag: this.handleMove, dragstop: this.endInteraction })
                    : this.isTouch
                    ? this.listenTo(e, { touchmove: this.handleTouchMove, touchend: this.endInteraction, scroll: this.handleTouchScroll })
                    : this.listenTo(e, { mousemove: this.handleMouseMove, mouseup: this.endInteraction }),
    ...
    var Se = bt.extend(ge, {
        ...
        be = (Zt.Grid = bt.extend(ge, {
            ...
            dayTouchStart: function (t) {
                ...
                n.isSelected ||
                    n.selectedEvent ||
                    ((e = n.opt("selectLongPressDelay")), null == e && (e = n.opt("longPressDelay")), this.dayClickListener.startInteraction(t), n.opt("selectable") && this.daySelectListener.startInteraction(t, { delay: e }));
            },
                ...
                return (
                    Z(t, i.activeRange)
                        ? (r.push("fc-" + Kt[t.day()]),
                          ...
                          (n = i.calendar.getNow()),
                          t.isSame(n, "day") ? (r.push("fc-today"), !0 !== e && r.push(i.highlightStateClass)) : t < n ? r.push("fc-past") : r.push("fc-future"))
    ...
    be.mixin({
        ...
        handleSegMouseout: function (t, e) {
            (e = e || {}),
                this.mousedOverSeg &&
                    ((t = t || this.mousedOverSeg), (this.mousedOverSeg = null), this.view.isEventResizable(t.event) && t.el.removeClass("fc-allow-mouse-resize"), this.view.publiclyTrigger("eventMouseout", t.el[0], t.event, e));
        },
        ...
        handleSegTouchStart: function (t, e) {
            ...
            o && l && (u = this.startSegResize(t, e)),
                u || (!a && !l) || ((i = r.opt("eventLongPressDelay")), null == i && (i = r.opt("longPressDelay")), (n = a ? this.buildSegDragListener(t) : this.buildSegSelectListener(t)), n.startInteraction(e, { delay: o ? 0 : i }));
        },
        ...
        buildSegDragListener: function (t) {
            ...
            var h = (this.segDragListener = new ye(a, {
                ...
                interactionStart: function (i) {
                    (t.component = r),
                        (e = !1),
                        (n = new Se(t.el, { additionalClass: "fc-dragging", parentEl: a.el, opacity: h.isTouch ? null : a.opt("dragOpacity"), revertDuration: a.opt("dragRevertDuration"), zIndex: 2 })),
                        n.hide(),
                        n.start(i);
                },
                ...
                hitOver: function (e, o, l) {
                    ...
                    t.hit && (l = t.hit),
                        ...
                        c && d ? ((i = r.computeEventDrop(c, d, u)), (g = i && r.isEventLocationAllowed(i, u))) : (g = !1),
                        g || ((i = null), s()),
                        i && (f = a.renderDrag(i, t)) ? (f.addClass("fc-dragging"), h.isTouch || r.applyDragOpacity(f), n.hide()) : n.show(),
                        o && (i = null);
                },
                hitOut: function () {
        ...
        computeEventDrop: function (t, e, n) {
            ...
            return (
                o.hasTime() === a.hasTime()
                    ? ((i = this.diffDates(a, o)), n.allDay && tt(i) ? ((r = { start: n.start.clone(), end: s.getEventEnd(n), allDay: !1 }), s.normalizeEventTimes(r)) : (r = xt(n)), r.start.add(i), r.end && r.end.add(i))
        ...
        buildSegResizeListener: function (t, e) {
            ...
            return (this.segResizeListener = new ye(this, {
                ...
                hitOver: function (n, o, l) {
                    ...
                    d && f ? ((i = e ? r.computeEventStartResize(d, f, h) : r.computeEventEndResize(d, f, h)), (u = i && r.isEventLocationAllowed(i, h))) : (u = !1),
                        u ? i.start.isSame(h.start.clone().stripZone()) && i.end.isSame(c.clone().stripZone()) && (i = null) : ((i = null), s()),
        ...
        eventsToSegs: function (e, n) {
            ...
            return (
                t.each(r, function (t, e) {
                    ...
                    else for (o = 0; o < l.length; o++) s.push.apply(s, i.eventRangeToSegs(l[o], a[o], n));
                }),
                s
            );
        },
    ...
    var Ee = (Zt.DayTableMixin = {
            ...
            updateDayTable: function () {
                for (var t, e, n, i = this.view, r = this.start.clone(), s = -1, o = [], a = []; r.isBefore(this.end); ) i.isHiddenDay(r) ? o.push(s + 0.5) : (s++, o.push(s), a.push(r.clone())), r.add(1, "days");
            ...
            sliceRangeByRow: function (t) {
                ...
                for (e = 0; e < this.rowCnt; e++)
                    (n = e * o),
                        ...
                        (r = Math.ceil(r)),
                        (s = Math.floor(s)),
                        r <= s && h.push({ row: e, firstRowDayIndex: r - n, lastRowDayIndex: s - n, isStart: r === l, isEnd: s === u });
                return h;
            },
            ...
            renderHeadDateCellHtml: function (t, e, n) {
                ...
                return (
                    1 === this.rowCnt ? (s = s.concat(this.getDayClasses(t, !0))) : s.push("fc-" + Kt[t.day()]),
                    '<th class="' +
                        s.join(" ") +
                        '"' +
                        (1 === (r && this.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") +
                        (e > 1 ? ' colspan="' + e + '"' : "") +
                        (n ? " " + n : "") +
                        ">" +
                        (r ? i.buildGotoAnchorHtml({ date: t, forceOff: this.rowCnt > 1 || 1 === this.colCnt }, o) : o) +
                        "</th>"
                );
            },
            ...
            renderDates: function (t) {
                ...
                for (
                    this.el.html(o),
                        ...
                        this.colCoordCache = new ve({ els: this.cellEls.slice(0, this.colCnt), isHorizontal: !0 }),
                        e = 0;
                    e < r;
                    e++
                )
            ...
            renderNumberCellHtml: function (t) {
                ...
                return o || i.cellWeekNumbersVisible
                    ? ((e = this.getDayClasses(t)),
                      ...
                      i.cellWeekNumbersVisible && t.day() == n && (r += i.buildGotoAnchorHtml({ date: t, type: "week" }, { class: "fc-week-number" }, t.format("w"))),
                      o && (r += i.buildGotoAnchorHtml(t, { class: "fc-day-number" }, t.date())),
                      (r += "</td>"))
                    : "<td/>";
            },
            computeEventTimeFormat: function () {
            ...
            renderMoreLink: function (e, n, i) {
                ...
                return t('<a class="fc-more"/>')
                    ...
                    .on("click", function (o) {
                        ...
                        "function" == typeof a && (a = s.publiclyTrigger("eventLimitClick", null, { date: l, dayEl: h, moreEl: u, segs: d, hiddenSegs: f }, o)),
    ...
    var Te = (Zt.TimeGrid = be.extend(Ee, {
        ...
        sliceRangeByTimes: function (t) {
            var e,
                ...
                r,
                s = [];
            for (n = 0; n < this.daysPerRow; n++) (i = this.dayDates[n].clone().time(0)), (r = { start: i.clone().add(this.view.minTime), end: i.clone().add(this.view.maxTime) }), (e = z(t, r)) && ((e.dayIndex = n), s.push(e));
            return s;
        },
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                ...
                '<a class="' +
                    ...
                    (c ? ' style="' + c + '"' : "") +
                    '><div class="fc-content">' +
                    (n ? '<div class="fc-time" data-start="' + ht(r) + '" data-full="' + ht(i) + '"><span>' + ht(n) + "</span></div>" : "") +
    ...
    var Ce = (Zt.View = ue.extend({
        ...
        computeTitle: function () {
            var t;
            return (
                (t = /^(year|month)$/.test(this.currentRangeUnit) ? this.currentRange : this.activeRange),
                this.formatRange({ start: this.calendar.applyTimezone(t.start), end: this.calendar.applyTimezone(t.end) }, this.opt("titleFormat") || this.computeTitleFormat(), this.opt("titleRangeSeparator"))
            );
        },
        ...
        Ce.mixin({
            ...
            buildDateProfile: function (t, n, i) {
                ...
                return (
                    ...
                    (t = j(t, o)),
                    (a = $(r.range, l)),
                    { validRange: l, currentRange: r.range, currentRangeUnit: r.unit, activeRange: o, renderRange: s, minTime: u, maxTime: h, isValid: a, date: t, dateIncrement: this.buildDateIncrement(r.duration) }
                );
            },
            ...
            buildCurrentRangeInfo: function (t, e) {
                ...
                return (
                    this.viewSpec.duration
                        ? ((i = this.viewSpec.duration), (r = this.viewSpec.durationUnit), (s = this.buildRangeFromDuration(t, e, i, r)))
                        : (n = this.opt("dayCount"))
                        ? ((r = "day"), (s = this.buildRangeFromDayCount(t, e, n)))
                        : (s = this.buildCustomVisibleRange(t))
                        ? (r = V(s.start, s.end))
                        : ((i = this.getFallbackDuration()), (r = V(i)), (s = this.buildRangeFromDuration(t, e, i, r))),
            ...
            buildRangeFromDuration: function (t, n, i, r) {
                var s,
                    ...
                    u = t.clone();
                return (
                    i.as("days") <= 1 && this.isHiddenDay(u) && ((u = this.skipHiddenDays(u, n)), u.startOf("day")),
                    l || ((o = this.opt("dateIncrement")), o ? ((a = e.duration(o)), (l = a < i ? O(a, o) : r)) : (l = r)),
                    u.startOf(l),
                    (s = u.clone().add(i)),
                    { start: u, end: s }
                );
            ...
            moment: function () {
                ...
                return (
                    "local" === this.opt("timezone")
                        ...
                        : (t = "UTC" === this.opt("timezone") ? Zt.moment.utc.apply(null, arguments) : Zt.moment.parseZone.apply(null, arguments)),
            ...
            buildViewSpec: function (t) {
                for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], h = [], c = [], d = t; d; )
                    (i = $t[d]),
                        ...
                        i && (u.unshift(i), h.unshift(i.defaults || {}), (s = s || i.duration), (d = d || i.type)),
                        r && (c.unshift(r), (s = s || r.duration), (d = d || r.type));
                return (
                    (i = it(u)),
                    (i.type = t),
                    !!i.class &&
                        ((s = s || this.dynamicOverrides.duration || this.overrides.duration),
                        s && ((o = e.duration(s)), o.valueOf() && ((a = O(o, s)), (i.duration = o), (i.durationUnit = a), 1 === o.as(a) && ((i.singleUnit = a), c.unshift(l[a] || {})))),
                        (i.defaults = n(h)),
                        (i.overrides = n(c)),
        ...
        Re.mixin({
            ...
            destroy: function () {
                this.view && this.view.removeElement(),
                    ...
                    this.el.off(".fc"),
                    this.windowResizeProxy && (t(window).unbind("resize", this.windowResizeProxy), (this.windowResizeProxy = null)),
                    we.unneeded();
            },
            ...
            renderView: function (e, n) {
                ...
                i && (this.freezeContentHeight(), this.clearView()),
                    !this.view &&
                        e &&
                        ((this.view = this.viewsByType[e] || (this.viewsByType[e] = this.instantiateView(e))),
                    ...
                    this.view && (n && this.view.addForcedScroll(n), this.elementVisible() && (this.currentDate = this.view.setDate(this.currentDate))),
    ...
    var Ge = (Zt.AgendaView = Ce.extend({
            ...
            setHeight: function (t, e) {
                ...
                this.bottomRuleEl.hide(),
                    ...
                    this.dayGrid && (this.dayGrid.removeSegPopover(), (n = this.opt("eventLimit")), n && "number" != typeof n && (n = Pe), n && this.dayGrid.limitRows(n)),
                    e ||
            ...
            renderHeadIntroHtml: function () {
                ...
                return e.opt("weekNumbers")
                    ? ((t = this.start.format(e.opt("smallWeekFormat"))),
                      '<th class="fc-axis fc-week-number ' + e.widgetHeaderClass + '" ' + e.axisStyleAttr() + ">" + e.buildGotoAnchorHtml({ date: this.start, type: "week", forceOff: this.colCnt > 1 }, ht(t)) + "</th>")
        ...
        Ye = be.extend({
            ...
            dayHeaderHtml: function (t) {
                ...
                return (
                    ...
                    e.widgetHeaderClass +
                    '" colspan="3">' +
                    (n ? e.buildGotoAnchorHtml(t, { class: "fc-list-heading-main" }, ht(t.format(n))) : "") +
                    (i ? e.buildGotoAnchorHtml(t, { class: "fc-list-heading-alt" }, ht(t.format(i))) : "") +
                    "</td></tr>"
                );
            },
            fgSegHtml: function (t) {
                var e,
                    ...
                    o = s.url;
                return (
                    (e = s.allDay ? n.getAllDayHtml() : n.isMultiDayEvent(s) ? (t.isStart || t.isEnd ? ht(this.getEventTimeText(t)) : n.getAllDayHtml()) : ht(this.getEventTimeText(s))),
                    o && i.push("fc-has-url"),
                    '<tr class="' +
                        i.join(" ") +
                        '">' +
    ...
    return (
        ($t.list = { class: We, buttonTextKey: "list", defaults: { buttonText: "list", listDayFormat: "LL", noEventsMessage: "No events to display" } }),
        ($t.listDay = { type: "list", duration: { days: 1 }, defaults: { listDayFormat: "dddd" } }),
        ($t.listWeek = { type: "list", duration: { weeks: 1 }, defaults: { listDayFormat: "dddd", listDayAltFormat: "LL" } }),
        ($t.listMonth = { type: "list", duration: { month: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        ($t.listYear = { type: "list", duration: { year: 1 }, defaults: { listDayAltFormat: "dddd" } }),
        Zt
    );
});
