...
!(function (a) {
    ...
    var n = ":not(:disabled):not(.ajs-reset)",
        ...
        p = {
            ...
            glossary: { title: "AlertifyJS", ok: "OK", cancel: "Cancel", acccpt: "Accept", deny: "Deny", confirm: "Confirm", decline: "Decline", close: "Close", maximize: "Maximize", restore: "Restore" },
        ...
        w = (function () {
            function m(a) {
                if (!a.__internal) {
                    ...
                    var c;
                    "function" == typeof a.setup ? ((c = a.setup()), (c.options = c.options || {}), (c.focus = c.focus || {})) : (c = { buttons: [], focus: { element: null, select: !1 }, options: {} }),
            ...
            function w(d) {
                y.defaults.preventBodyShift &&
                    (d && document.documentElement.scrollHeight > document.documentElement.clientHeight
                        ? ((Ja = Ba), (Ia = a.getComputedStyle(document.body).top), b(document.body, Ha.fixed), (document.body.style.top = -Ba + "px"))
            ...
            function F(a, b, c, d, e) {
                ...
                if (void 0 === e && "string" == typeof d) (f.op = "get"), b.hasOwnProperty(d) ? ((f.found = !0), (f.value = b[d])) : ((f.found = !1), (f.value = void 0));
                    ...
                    if (((f.op = "set"), "object" == typeof d)) {
                        var h = d;
                        for (var i in h) b.hasOwnProperty(i) ? (b[i] !== h[i] && ((g = b[i]), (b[i] = h[i]), c.call(a, i, g, h[i])), f.items.push({ key: i, value: h[i], found: !0 })) : f.items.push({ key: i, value: h[i], found: !1 });
                    } else {
                ...
                if (null === Wa && !c.isMaximized() && c.get("movable")) {
                    ...
                    if (("touchstart" === a.type ? (a.preventDefault(), (d = a.targetTouches[0]), (Ra = "clientX"), (Sa = "clientY")) : 0 === a.button && (d = a), d)) {
                        ...
                        if (
                            ...
                            (Pa = d[Ra] - e),
                            (Qa = d[Sa] - f),
                            c.isModal() ? (Qa += c.elements.modal.scrollTop) : c.isPinned() && (Qa -= document.body.scrollTop),
                            c.get("moveBounded"))
                        ) {
                            var h = g,
                                i = -e,
                ...
                setHeader: function (b) {
                    return (
                        "string" == typeof b
                            ...
                            : b instanceof a.HTMLElement && this.elements.header.firstChild !== b && (g(this.elements.header), this.elements.header.appendChild(b)),
                        this
                    );
                },
                setContent: function (b) {
                    return (
                        "string" == typeof b
                            ...
                            : b instanceof a.HTMLElement && this.elements.content.firstChild !== b && (g(this.elements.content), this.elements.content.appendChild(b)),
                        this
                    );
                },
                ...
                show: function (a, d) {
                    if ((m(this), this.__internal.isOpen)) {
                        ...
                        if (
                            ...
                            document.body.hasAttribute("tabindex") || document.body.setAttribute("tabindex", (Ea = "0")),
                            "function" == typeof this.prepare && this.prepare(),
                            qa(this),
                            void 0 !== a && this.set("modal", a),
                            n(),
                            s(),
                            "string" == typeof d && "" !== d && ((this.__internal.className = d), b(this.elements.root, d)),
                            ...
                            (this.__internal.timerIn = setTimeout(this.__internal.transitionInHandler, v.supported ? 1e3 : 100)),
                            Fa)
                        ) {
                ...
                close: function () {
                    return (
                        this.__internal.isOpen &&
                            ...
                            (this.__internal.timerOut = setTimeout(this.__internal.transitionOutHandler, v.supported ? 1e3 : 100)),
                            b(this.elements.root, Ha.hidden),
                            (Da = this.elements.modal.offsetWidth),
                            y.defaults.maintainFocus && this.__internal.activeElement && (this.__internal.activeElement.focus(), (this.__internal.activeElement = null)),
            ...
            function i(d, h) {
                ...
                return o({
                            ...
                            this.__internal.pushed &&
                                ...
                                ("function" == typeof this.ondismiss && !1 === this.ondismiss.call(this)) ||
                                    ...
                                    void 0 !== this.element &&
                                        ...
                                        ((this.__internal.transitionTimeout = setTimeout(this.__internal.transitionEndHandler, v.supported ? 1e3 : 100)),
                    ...
                    setContent: function (c) {
                        if (
                            ("string" == typeof c ? (g(this.element), (this.element.innerHTML = c)) : c instanceof a.HTMLElement && this.element.firstChild !== c && (g(this.element), this.element.appendChild(c)),
                ...
                setup: function () {
                    return {
                        buttons: [
                            ...
                            { text: y.defaults.glossary.cancel, key: o.ESC, invokeOnClose: !0, className: y.defaults.theme.cancel },
                        ],
