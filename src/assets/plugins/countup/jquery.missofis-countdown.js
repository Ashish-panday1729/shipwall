    ...
    Plugin.prototype = {
		...
		*/
        ...
        pause: function () {
            ...
            // clear old interval
            if (undefined !== this._intervalID) window.clearInterval(this._intervalID);
        },
		...
		*/
        ...
        _parseSeconds: function (seconds) {
            ...
            } else if (seconds >= 3600) _parsedTime.hours = Math.floor(seconds / 3600);

            // get minutes
            if (seconds >= 3600) _parsedTime.minutes = Math.floor((seconds % 3600) / 60);
    ...
    $.fn[PLUGIN_NAME] = function (options) {
        ...
        if (undefined === options || "object" === typeof options) {
            return this.each(function () {
                ...
                if (!$.data(this, "plugin_" + PLUGIN_NAME)) $.data(this, "plugin_" + PLUGIN_NAME, new Plugin(this, options));
            });
        }
