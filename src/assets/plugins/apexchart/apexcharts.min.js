                  ...
                  [
                      ...
                      },
                      {
                          ...
                          value: function () {
                              ...
                              return (
                                  d.attr({ x: t, y: e, width: i > 0 ? i : 0, height: a > 0 ? a : 0, rx: s, ry: s, opacity: n, "stroke-width": null !== o ? o : 0, stroke: null !== l ? l : "none", "stroke-dasharray": h }),
                      ...
                      },
                      {
                          ...
                          value: function (t, e) {
                              ...
                              "function" == typeof i.config.chart.events.dataPointSelection &&
                                  i.config.chart.events.dataPointSelection(e, this.ctx, { selectedDataPoints: i.globals.selectedDataPoints, seriesIndex: s, dataPointIndex: r, w: i }),
                              ...
                              return (
                                  i.config.xaxis.convertedCatToNumeric &&
                                      (a = t.map(function (t, a) {
                                          return i.config.xaxis.labels.formatter(t - i.globals.minX + 1, { i: a, dateFormatter: new y(e.ctx).formatDate, w: i });
                                      })),
                                  a
                              );
                          },
                      ...
                      value: function () {
                          return {
                              ...
                              plotOptions: {
                                  ...
                                  treemap: { enableShades: !0, shadeIntensity: 0.5, distributed: !1, useFillColorAsStroke: !1, colorScale: { inverse: !1, ranges: [], min: void 0, max: void 0 } },
                                  radialBar: {
                                      inverseOrder: !1,
                                      startAngle: 0,
                                      endAngle: 360,
                              ...
                              for (
                                  ...
                                  t.globals.dom.elGraphical.add(r[o]),
                                      !s ||
                                          ...
                                          ("scatter" !== t.config.chart.type && "bubble" !== t.config.chart.type && t.globals.dataPoints > 1 && n[o].classList.add("apexcharts-element-hidden")),
                          ...
                          if ("bubble" !== t.config.chart.type)
                              for (var e = t.globals.dom.baseEl.querySelectorAll(".apexcharts-datalabels text"), i = 0; i < e.length; i++) {
                                  ...
                                  if ((s.width && s.height && (r = this.addBackgroundToDataLabel(a, s)), r)) {
                                      ...
                                      t.config.chart.animations.enabled && !t.globals.resized && !t.globals.dataChanged ? r.animate().attr({ fill: n }) : r.attr({ fill: n }),
                          ...
                          if (c.enabled && !m) {
                              ...
                              if (
                                  ("vertical" === d.config.plotOptions.bar.dataLabels.orientation &&
                                      ("top" === w && (c.textAnchor = y ? "end" : "start"), "center" === w && (c.textAnchor = "middle"), "bottom" === w && (c.textAnchor = y ? "end" : "start")),
                              ...
                              d.config.chart.stacked &&
                                  ...
                                  (this.barCtx.isHorizontal ? ((h > 0 && o.width / 1.6 > h) || (h < 0 && o.width / 1.6 < h)) && (v = "") : o.height / 1.6 > l && (v = ""));
                              var k = n({}, c);
                  ...
                  },
                  {
                      ...
                      value: function (t) {
                          ...
                          L.attr("clip-path", "url(#gridRectMask".concat(A.globals.cuid, ")")),
                              ...
                              h.add(L);
                          var P = new M(this).handleBarDataLabels({ x: c, y: d, y1: g, y2: u, i: r, j: s, series: f, realIndex: e, barHeight: x, barWidth: m, barYPosition: v, renderedPath: L, visibleSeries: w });
              ...
              a(i, [
                  {
                      ...
                      value: function (e) {
                          ...
                          (this.chartType = a.chart.type),
                              "histogram" === this.chartType && ((a.chart.type = "bar"), (a = f.extend({ plotOptions: { bar: { columnWidth: "99.99%" } } }, a))),
                          ...
                          if (a && "object" === t(a)) {
                              var l = {};
                              (l =
                                  -1 !== ["line", "area", "bar", "candlestick", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type)
                                      ? r[a.chart.type]()
                                      : r.line()),
                  ...
                  },
                  {
                      ...
                      value: function (t, e, i) {
                          var a = [],
                              ...
                              n = "Please provide [Start, End] values in valid format.",
                  ...
                  },
                  {
                      ...
                      value: function (t, e, i) {
                          var a = this.w,
                              ...
                              n = [],
                              o = [],
                              l = "Please provide [Open, High, Low and Close] values in valid format.";
                          if ("array" === t) {
                          ...
                          for (
                              ...
                              if ((("rangeBar" !== a.chart.type && "rangeArea" !== a.chart.type && "rangeBar" !== t[l].type && "rangeArea" !== t[l].type) || ((s.isRangeData = !0), this.handleRangeData(t, l)), this.isMultiFormat()))
                                  ...
                                  "datetime" === a.xaxis.type
                                      ...
                                      : "numeric" === a.xaxis.type && ((s.isXNumeric = !0), n.length > 0 && ((this.twoDSeriesX = n), s.seriesX.push(this.twoDSeriesX))),
                                      s.labels.push(this.twoDSeriesX);
                  ...
                  },
                  {
                      ...
                      value: function (t, e, i) {
                          ...
                          return (
                              f.isNumber(t) &&
                                  (t =
                                      0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 10 ? t.toFixed(1) : t.toFixed(0)),
                              t
                          );
                      },
                  },
              ...
              a(t, [
                  {
                      ...
                      value: function (t, e, i, a) {
                          ...
                          return (
                              !Array.isArray(l) && (0 === l.indexOf("NaN") || 0 === l.toLowerCase().indexOf("invalid") || l.toLowerCase().indexOf("infinity") >= 0 || (s.indexOf(l) >= 0 && m)) && (l = ""),
                  ...
                  },
                  {
                      ...
                      value: function (t, e, i) {
                          ...
                          if ((r.logarithmic && n <= 5 && (a.invalidLogScale = !0), r.logarithmic && n > 5))
                              (a.allSeriesCollapsed = !1), (a.yAxisScale[t] = this.logarithmicScale(t, e, i, r.tickAmount ? r.tickAmount : Math.floor(Math.log10(i))));
                  ...
                  },
                  {
                      ...
                      value: function () {
                          ...
                          if (
                              ...
                              ("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type || ("rangeBar" === e.chart.type && !t.isBarHorizontal)) &&
                                  t.minY === Number.MIN_VALUE &&
                                  i !== -Number.MAX_VALUE &&
                                  i !== t.maxY)
                          ) {
                                  ...
                                  function (t) {
                                      ...
                                      "mousemove" === t.type || "touchmove" === t.type
                                          ...
                                          : (("mouseup" === t.type && 1 === t.which) || "touchend" === t.type) &&
                                            ("function" == typeof e.config.chart.events.click && e.config.chart.events.click(t, i, a), i.ctx.events.fireEvent("click", [t, i, a]));
                                  },
                                  { capture: !1, passive: !0 }
                              );
                          }),
                                    ...
                                    Array.isArray(e.config.colors) &&
                                        ...
                                        (e.globals.colors = e.config.series.map(function (i, a) {
                                            ...
                                            return (
                                                ...
                                                "function" == typeof s
                                                    ? ((t.isColorFn = !0), s({ value: e.globals.axisCharts ? (e.globals.series[a][0] ? e.globals.series[a][0] : 0) : e.globals.series[a], seriesIndex: a, dataPointIndex: a, w: e }))
                                                    : s
                                            );
                                        }))),
              ...
              a(t, [
                  ...
                  },
                  {
                      ...
                      value: function () {
                          ...
                          return (
                              1.05 * (t = new b(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth && 0 !== e.config.xaxis.labels.rotate && (e.globals.overlappingXLabels = !0), t
                          );
                      },
                  },
                  {
                      ...
                      value: function (t, e) {
                          ...
                          i.config.yaxis.map(function (s, r) {
                              -1 !== i.globals.ignoreYAxisIndexes.indexOf(r) ||
                                  s.floating ||
                                  a.isYAxisHidden(r) ||
                                  (s.opposite && (i.globals.translateX = i.globals.translateX - (e[r].width + t[r].width) - parseInt(i.config.yaxis[r].labels.style.fontSize, 10) / 1.2 - 12),
                      ...
                      value: function () {
                          ...
                          for (var r = t.globals.legendFormatter, n = t.config.legend.inverseOrder, o = n ? i.length - 1 : 0; n ? o >= 0 : o <= i.length - 1; n ? o-- : o++) {
                              ...
                              (S.background = a[o]),
                                  ...
                                  void 0 !== t.globals.seriesColors[o] && ((S.background = t.globals.seriesColors[o]), (S.color = t.globals.seriesColors[o])),
                              ...
                              t.config.legend.showForNullSeries ||
                                  (T.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && C.classList.add("apexcharts-hidden-null-series")),
                  ...
                  },
                  {
                      ...
                      value: function (t) {
                          if (t.target.classList.contains("apexcharts-legend-text") || t.target.classList.contains("apexcharts-legend-marker")) {
                              ...
                              "function" == typeof s && t.target.classList.contains("apexcharts-legend-marker") && (s(this.ctx, e, this.w), this.ctx.events.fireEvent("legendMarkerClick", [this.ctx, e, this.w])),
                          ...
                          for (
                              var p = function (t, r) {
                                      ...
                                      (u = i.getSeriesName({ fn: p.yLbTitleFormatter, index: a, seriesIndex: a, j: s })),
                                          "treemap" === h.config.chart.type && (u = p.yLbTitleFormatter(String(h.config.series[a].data[s].x), { series: h.globals.series, seriesIndex: a, dataPointIndex: s, w: h }));
                                      var x = h.config.tooltip.inverseOrder ? r : t;
                                      if (h.globals.axisCharts) {
                                          var b = function (t) {
                                              return p.yLbFormatter(h.globals.series[t][s], { series: h.globals.series, seriesIndex: t, dataPointIndex: s, w: h });
                                          };
                                          o
                                              ? ((p = i.getFormatters(x)), (u = i.getSeriesName({ fn: p.yLbTitleFormatter, index: x, seriesIndex: a, j: s })), (f = h.globals.colors[x]), (e = b(x)))
                                              : (l && l.target && l.target.getAttribute("fill") && (f = l.target.getAttribute("fill")), (e = b(a)));
                                      }
                                      null === s && (e = p.yLbFormatter(h.globals.series[a], h)), i.DOMHandling({ i: a, t: x, j: s, ttItems: n, values: { val: e, xVal: c, xAxisTTVal: g, zVal: d }, seriesName: u, shared: o, pColor: f });
                                  },
                                  x = 0,
          ...
          return (
              a(t, [
                  ...
                  },
                  {
                      ...
                      value: function (t) {
                          for (
                              var e = this.w, i = this.ttCtx, a = t, s = e.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), r = e.config.markers.hover.size, n = 0;
                              n < s.length;
                              n++
                          ) {
                      ...
                      value: function (t) {
                          ...
                          for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                              ...
                              for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, x = 0; x < l[h].length; x++) {
                                  ...
                                  var L = (0, e.config.dataLabels.formatter)(e.globals.series[h][x], { value: e.globals.series[h][x], seriesIndex: h, dataPointIndex: x, w: e }),
                  ...
                  },
                  {
                      ...
                      value: function (t, e) {
                          ...
                          for (var g = 0; g < t.length; g++) {
                              var u = s.group({ class: "apexcharts-series apexcharts-pie-series", seriesName: f.escapeString(i.globals.seriesNames[g]), rel: g + 1, "data:realIndex": g });
                              ...
                              this.addListeners(y, this.donutDataLabels), b.setAttrs(y.node, { "data:angle": x, "data:startAngle": l, "data:strokeWidth": this.strokeWidth, "data:value": e[g] });
                              var k = { x: 0, y: 0 };
                              "pie" === this.chartType || "polarArea" === this.chartType
                                  ? (k = f.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (l + x / 2) % this.fullAngle))
                                  : "donut" === this.chartType &&
                                    (k = f.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (l + x / 2) % this.fullAngle)),
                                  u.add(y);
                              var A = 0;
                              if (
                                  (!this.initialAnim || i.globals.resized || i.globals.dataChanged
                                      ? this.animBeginArr.push(0)
                                      : (0 === (A = (x / this.fullAngle) * i.config.chart.animations.speed) && (A = 1), (this.animDur = A + this.animDur), this.animBeginArr.push(this.animDur)),
                                  this.dynamicAnim && i.globals.dataChanged
                                      ...
                                      : this.animatePaths(y, { size: this.sliceSizes[g], endAngle: c, startAngle: l, i: g, totalItems: t.length - 1, animBeginArr: this.animBeginArr, dur: A }),
                  ...
                  },
                  {
                      ...
                      value: function (t, e) {
                          ...
                          void 0 !== e.prevStartAngle &&
                              ...
                              ((r = e.prevEndAngle), (s = e.prevEndAngle < e.prevStartAngle ? this.fullAngle + e.prevEndAngle - e.prevStartAngle : e.prevEndAngle - e.prevStartAngle)),
                  ...
                  },
                  {
                      ...
                      value: function (t, e, i, a, s, r) {
                          ...
                          l.globals.dataChanged &&
                              ...
                              r.prevEndAngle &&
                              ((n = o.getPiePath({ me: o, startAngle: r.prevStartAngle, angle: r.prevEndAngle < r.prevStartAngle ? this.fullAngle + r.prevEndAngle - r.prevStartAngle : r.prevEndAngle - r.prevStartAngle, size: c })),
                              t.attr({ d: n })),
                              0 !== r.dur
                                  ? t
                  ...
                  },
                  {
                      ...
                      value: function () {
                          ...
                          for (var c = t.globals.radialSize, d = c / (h - 1), g = 0; g < h - 1; g++) {
                              ...
                              if (
                                  (u.attr({ cx: this.centerX, cy: this.centerY, fill: "none", "stroke-width": t.config.plotOptions.polarArea.rings.strokeWidth, stroke: t.config.plotOptions.polarArea.rings.strokeColor }),
                                  ...
                                  for (var m = 0; m < c.linePathsTo.length; m++) {
                                      var v = e.graphics.renderPaths(
                                          n(
                                              n({}, d),
                                              {},
                                              { pathFrom: null === b ? c.linePathsFrom[m] : b, pathTo: c.linePathsTo[m], strokeWidth: Array.isArray(e.strokeWidth) ? e.strokeWidth[o] : e.strokeWidth, fill: "none", drawShadow: !1 }
                                          )
                                      );
                                      h.add(v);
                      ...
                      value: function (t) {
                          ...
                          for (var m = x ? t.series.length - 1 : 0; x ? m >= 0 : m < t.series.length; x ? m-- : m++) {
                              ...
                              !this.initialAnim ||
                                  ...
                                  ((M = ((S - w) / 360) * e.config.chart.animations.speed), (this.animDur = M / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                  ...
                  },
                  {
                      ...
                      value: function (t, e, i, a) {
                          ...
                          if (s.config.plotOptions.radialBar.hollow.imageClipped)
                              r.clippedImgArea({ width: i, height: i, image: o, patternID: "pattern".concat(s.globals.cuid).concat(n) }), (a = "url(#pattern".concat(s.globals.cuid).concat(n, ")"));
                          else {
                          ...
                          for (var e = t.pathFromLine, i = t.pathFromArea, a = t.realIndex, s = this.w, r = 0; r < s.globals.previousPaths.length; r++) {
                              ...
                              ("line" === n.type || "area" === n.type) &&
                                  ...
                                  ("line" === n.type
                                      ...
                                      : "area" === n.type &&
                                        ((this.lineCtx.appendPathFrom = !1), (i = s.globals.previousPaths[r].paths[0].d), s.config.stroke.show && s.globals.previousPaths[r].paths[1] && (e = s.globals.previousPaths[r].paths[1].d)));
                          }
              ...
              a(t, [
                  {
                      ...
                      value: function (t, e, i) {
                          ...
                          for (var l = [], h = 0; h < t.length; h++) {
                              ...
                              this._handlePaths({ type: r, realIndex: c, i: h, paths: y }), this.elSeries.add(this.elPointsMain), this.elSeries.add(this.elDataLabelsWrap), l.push(this.elSeries);
                          }
                  ...
                  },
                  {
                      ...
                      value: function (t) {
                          ...
                          if (e.minDate > 1 || e.minMonth > 0) {
                              ...
                              (o = (l.determineDaysOfYear(e.minYear) - h + 1) * s), (n = e.minYear + 1), this.timeScaleArray.push({ position: o, value: n, unit: "year", year: n, month: f.monthMod(i + 1) });
                          } else 1 === e.minDate && 0 === e.minMonth && this.timeScaleArray.push({ position: o, value: n, unit: "year", year: a, month: f.monthMod(i + 1) });
                  ...
                  },
                  {
                      ...
                      value: function (t) {
                          var e = t.firstVal,
                              ...
                              p = n,
                              x = a;
                          this.timeScaleArray.push({ position: h, value: c, unit: "minute", day: g, hour: x, minute: d, year: p, month: f.monthMod(u) });
                          for (var b = h, m = 0; m < l; m++)
                              d >= 60 && ((d = 0), 24 === (x += 1) && (x = 0)),
                                  (b = o + b),
                                  this.timeScaleArray.push({ position: b, value: d, unit: "minute", hour: x, minute: d, day: g, year: this._getYear(n, u, 0), month: f.monthMod(u) }),
                                  d++;
                      },
                  },
                  {
                              ...
                              (a += t[e][0]),
                                  null != t[e][1] &&
                                      ...
                                      null != t[e][2] &&
                                          ...
                                          (a += t[e][2]),
                                          null != t[e][3] &&
                                              ((a += " "), (a += t[e][3]), (a += " "), (a += t[e][4]), null != t[e][5] && ((a += " "), (a += t[e][5]), (a += " "), (a += t[e][6]), null != t[e][7] && ((a += " "), (a += t[e][7]))))));
                          return a + " ";
                      })(this.value);
                  },
                  move: function (t, e) {
