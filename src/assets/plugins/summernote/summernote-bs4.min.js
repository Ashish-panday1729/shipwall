!(function (t, e) {
    ...
    return (function (t) {
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                var t = this.options.dialogsInBody ? this.$body : this.options.container,
                                    e = [
                                        '<p class="text-center">',
                                        '<a href="javascript:void(0)" target="_blank">Summernote 0.8.18</a> · ',
                                        '<a href="javascript:void(0)" target="_blank">Project</a> · ',
                                        '<a href="javascript:void(0)" target="_blank">Issues</a>',
                                        "</p>",
                                    ].join("");
                                this.$dialog = this.ui
                                    .dialog({
        ...
        53: function (t, e, n) {
                    ...
                    e.fade && t.addClass("fade"),
                        ...
                        t.html(
                            [
                                ...
                                e.title ? '<div class="modal-header"><h4 class="modal-title">' + e.title + '</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>' : "",
                ...
                w = r.a.create('<div class="form-check"></div>', function (t, e) {
                    t.html(
                        [
                            ...
                            '<input type="checkbox" class="form-check-input"' + (e.id ? ' id="note-' + e.id + '"' : ""),
                            e.checked ? " checked" : "",
            ...
            n(3), n(5);
            (i.a.summernote = i.a.extend(i.a.summernote, { ui_template: x, interface: "bs4" })),
                (i.a.summernote.options.styleTags = ["p", { title: "Blockquote", tag: "blockquote", className: "blockquote", value: "blockquote" }, "pre", "h1", "h2", "h3", "h4", "h5", "h6"]);
        },
    });
});