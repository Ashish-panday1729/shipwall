!(function (a) {
    ...
    (function (a, b) {
            ...
            (c.is = function (a, b) {
                return (
                    ...
                    "finite" == b
                        ...
                        : "array" == b
                        ? a instanceof Array
                        : ("null" == b && null === a) || (b == typeof a && null !== a) || ("object" == b && a === Object(a)) || ("array" == b && Array.isArray && Array.isArray(a)) || W.call(a).slice(8, -1).toLowerCase() == b
                );
            }),
        ...
        (c.color = function (a) {
            ...
            (c.getRGB = f(function (a) {
                ...
                var b,
                    ...
                    j = a.match(X);
                return j
                    ? (j[2] && ((e = ab(j[2].substring(5), 16)), (d = ab(j[2].substring(3, 5), 16)), (b = ab(j[2].substring(1, 3), 16))),
                      j[3] && ((e = ab((h = j[3].charAt(3)) + h, 16)), (d = ab((h = j[3].charAt(2)) + h, 16)), (b = ab((h = j[3].charAt(1)) + h, 16))),
                      j[4] &&
                          ((i = j[4][J](eb)),
                          (b = _(i[0])),
                          "%" == i[0].slice(-1) && (b *= 2.55),
                      ...
                      j[5]
                          ...
                          ? ((i = j[6][J](eb)),
                            ...
                            i[3] && "%" == i[3].slice(-1) && (f /= 100),
                            c.hsl2rgb(b, d, e, f))
                          : ((j = { r: b, g: d, b: e, toString: g }), (j.hex = "#" + (16777216 | e | (d << 8) | (b << 16)).toString(16).slice(1)), c.is(f, "finite") && (j.opacity = f), j))
                ...
                (a.add = function (a, b, c, d, e, f) {
                    ...
                    (a.split = function () {
                        ...
                        var f = -e[0][1],
                            g = e[1][1];
                        return (
                            0 > g ? ((a.rotate = c.deg(N.acos(g))), 0 > f && (a.rotate = 360 - a.rotate)) : (a.rotate = c.deg(N.asin(f))),
                    ...
                    (a.toTransformString = function (a) {
                        ...
                        return b.isSimple
                            ? ((b.scalex = +b.scalex.toFixed(4)),
                              ...
                              (b.dx || b.dy ? "t" + [b.dx, b.dy] : G) + (1 != b.scalex || 1 != b.scaley ? "s" + [b.scalex, b.scaley, 0, 0] : G) + (b.rotate ? "r" + [b.rotate, 0, 0] : G))
        ...
        v.safari =
            ("Apple Computer, Inc." == navigator.vendor && ((Qb && Qb[1] < 4) || "iP" == navigator.platform.slice(0, 2))) || ("Google Inc." == navigator.vendor && Qb && Qb[1] < 8)
                ? function () {
        ...
        (v.getElementByPoint = function (a, b) {
            ...
            ($b.getBBox = function (a) {
                ...
                var b = this._;
                return a
                    ? ((b.dirty || !b.bboxwt) && ((this.realPath = qb[this.type](this)), (b.bboxwt = Bb(this.realPath)), (b.bboxwt.toString = p), (b.dirty = 0)), b.bboxwt)
                    : ((b.dirty || b.dirtyT || !b.bbox) &&
                          ((b.dirty || !this.realPath) && ((b.bboxwt = 0), (this.realPath = qb[this.type](this))), (b.bbox = Bb(rb(this.realPath, this.matrix))), (b.bbox.toString = p), (b.dirty = b.dirtyT = 0)),
                      b.bbox);
            }),
            ($b.clone = function () {
            ...
            ($b.glow = function (a) {
                ...
                a = a || {};
                var b = { width: (a.width || 10) + (+this.attr("stroke-width") || 1), fill: a.fill || !1, opacity: a.opacity || 0.5, offsetx: a.offsetx || 0, offsety: a.offsety || 0, color: a.color || "#000" },
                    c = b.width / 2,
                    d = this.paper,
                    e = d.set(),
            ...
            kc = function () {
                for (var a = +new Date(), d = 0; d < ic.length; d++) {
                    ...
                    if (!e.el.removed && !e.paused) {
                        ...
                        if (
                            (e.initstatus
                                ? ((h = ((e.initstatus * e.anim.top - e.prev) / (e.percent - e.prev)) * i), (e.status = e.initstatus), delete e.initstatus, e.stop && ic.splice(d--, 1))
                        ...
                        t = function (d, e, f) {
                            if ("path" == d.type) {
                                ...
                                if (
                                    ...
                                    f ? ((g = d._.arrows.startdx * u || 0), (h = c.getTotalLength(t.path) - g)) : ((g = 0), (h = c.getTotalLength(t.path) - (d._.arrows.enddx * u || 0))),
                                    ...
                                    switch (((k[o] = p), o)) {
                                        ...
                                        case "fill":
                                            ...
                                            if (E) {
                                                ...
                                                var F = q("image");
                                                (A.id = c.createUUID()),
                                                    q(A, { x: 0, y: 0, patternUnits: "userSpaceOnUse", height: 1, width: 1 }),
                                            ...
                                            if (G.error) {
                                                ...
                                                delete f.gradient,
                                                    delete k.gradient,
                                                    !c.is(k.opacity, "undefined") && c.is(f.opacity, "undefined") && q(i, { opacity: k.opacity }),
                                        ...
                                        case "stroke":
                                            (G = c.getRGB(p)),
                                                ...
                                                "stroke" == o && G[a]("opacity") && q(i, { "stroke-opacity": G.opacity > 1 ? G.opacity / 100 : G.opacity }),
                    ...
                    (z.prototype = A),
                        ...
                        (c._engine.create = function () {
                            ...
                            return (
                                ...
                                1 == b
                                    ? ((i.style.cssText = j + "position:absolute;left:" + d + "px;top:" + e + "px"), c._g.doc.body.appendChild(i), (h = 1))
                                    : ((i.style.cssText = j + "position:relative"), b.firstChild ? b.insertBefore(i, b.firstChild) : b.appendChild(i)),
                                (b = new c._Paper()),
                                (b.width = f),
                                (b.height = g),
                                (b.canvas = i),
                        ...
                        (c._engine.setViewBox = function (a, b, c, d, e) {
                            ...
                            var f,
                                ...
                                l = e ? "meet" : "xMinYMin";
                            for (
                                null == a ? (this._vbSize && (i = 1), delete this._vbSize, (f = "0 0 " + this.width + m + this.height)) : ((this._vbSize = i), (f = a + m + b + m + c + m + d)),
                ...
                if (c.vml) {
                        ...
                        B = function (e, i) {
                            ...
                            if (
                                ...
                                ((i.path && "path" == e.type) || q) &&
                                    ((l.path = x(~b(m.path).toLowerCase().indexOf("r") ? c._pathToAbsolute(m.path) : m.path)), "image" == e.type && ((e._.fillpos = [m.x, m.y]), (e._.fillsize = [m.width, m.height]), z(e, 1, 1, 0, 0, 0))),
                            ...
                            if ("clip-rect" in i) {
                                ...
                                if (4 == G.length) {
                                    ...
                                    (I.clip = c.format("rect({1}px {2}px {3}px {0}px)", G)),
                                        l.clipRect ||
                                            ((I.position = "absolute"), (I.top = 0), (I.left = 0), (I.width = e.paper.width + "px"), (I.height = e.paper.height + "px"), l.parentNode.insertBefore(H, l), H.appendChild(l), (l.clipRect = H));
                                }
                                ...
                                if (((K = K && K[0]), !K && (L = K = F(j)), "image" == e.type && i.src && (K.src = i.src), i.fill && (K.on = !0), (null == K.on || "none" == i.fill || null === i.fill) && (K.on = !1), K.on && i.fill)) {
                                    ...
                                    if (M) {
                                        ...
                                        (K.color = c.getRGB(i.fill).hex),
                                            (K.src = o),
                                            (K.type = "solid"),
                                            c.getRGB(i.fill).error && (s.type in { circle: 1, ellipse: 1 } || "r" != b(i.fill).charAt()) && C(s, i.fill, K) && ((m.fill = "none"), (m.gradient = i.fill), (K.rotate = !1));
                                }
                    ...
                    (D.prototype = E),
                        ...
                        (E.scale = function (a, c, e, f) {
                            ...
                            if (
                                ((a = b(a).split(k)),
                                a.length - 1 && ((c = d(a[1])), (e = d(a[2])), (f = d(a[3])), isNaN(e) && (e = null), isNaN(f) && (f = null)),
                                (a = d(a[0])),
                                null == c && (c = a),
                                null == f && (e = f),
                                null == e || null == f)
                        ...
                        (E.blur = function (a) {
                            ...
                            return (
                                (d = d.replace(r, o)),
                                0 !== +a
                                    ? ((this.attrs.blur = a), (b.filter = d + n + m + ".Blur(pixelradius=" + (+a || 1.5) + ")"), (b.margin = c.format("-{0}px 0 0 -{0}px", f(+a || 1.5))))
                        ...
                        (c._engine.setViewBox = function (a, b, d, e, f) {
                            ...
                            var h,
                                ...
                                l = 1 / g(d / j, e / k);
                            return (
                                f && ((h = k / e), (i = j / d), j > d * h && (a -= (j - d * h) / 2 / h), k > e * i && (b -= (k - e * i) / 2 / i)),
