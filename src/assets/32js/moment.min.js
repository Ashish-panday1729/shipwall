!(function (e, t) {
        ...
        if (!e._d) {
            ...
            for (
                o = e,
                    ...
                    null != e._dayOfYear &&
                        ((r = ct(e._a[me], s[me])), (e._dayOfYear > Se(r) || 0 === e._dayOfYear) && (g(e)._overflowDayOfYear = !0), (n = Ge(r, 0, e._dayOfYear)), (e._a[_e] = n.getUTCMonth()), (e._a[ye] = n.getUTCDate())),
                    t = 0;
                t < 3 && null == e._a[t];
                ++t
            )
    ...
    (c.createFromInputFallback = n(
        ...
        (c.ISO_8601 = function () {}),
        (c.RFC_2822 = function () {});
    var xt = n("moment().min is deprecated, use moment.max instead.", function () {
            var e = bt.apply(null, arguments);
            return this.isValid() && e.isValid() ? (e < this ? this : e) : p();
        }),
        Pt = n("moment().max is deprecated, use moment.min instead.", function () {
            var e = bt.apply(null, arguments);
    ...
    function $t(s, i) {
        return function (e, t) {
            ...
            return (
                null === t ||
                    isNaN(+t) ||
                    (T(i, "moment()." + i + "(period, number) is deprecated. Please use moment()." + i + "(number, period). ."), (n = e), (e = t), (t = n)),
    ...
    (mn.add = Jt),
        ...
        (mn.zone = n("moment().zone is deprecated, use moment().utcOffset instead.", function (e, t) {
            return null != e ? ("string" != typeof e && (e = -e), this.utcOffset(e, t), this) : -this.utcOffset();
        })),
        (mn.isDSTShifted = n("", function () {
